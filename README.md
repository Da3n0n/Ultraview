...
Token was verified against the provider API

🟡 Warning

OAuth token not validated recently

🔴 Expired

Server returned 401/403, or token has passed its expiry time
...
Open the Commands panel as a full-width editor
