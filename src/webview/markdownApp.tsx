...
function focusSelection(textarea: HTMLTextAreaElement | null, change: EditorChange | null) {
...
function App() {
    const state = (window as unknown as { __ultraviewWebviewState?: MarkdownWebviewState })
    ...
    const handleFormat = (
        formatter: (text: string, start: number, end: number) => EditorChange
    ) => {
            ...
            <div className="markdown-toolbar">
                <div className="markdown-toolbar-group">
                    <button
                        ...
                        onClick={() =>
                            handleFormat((text, start, end) => toggleHeading(text, start, 1))
                        }
                    >
                        H1
                    </button>
                    <button
                        className="markdown-button"
                        onClick={() =>
                            handleFormat((text, start, end) => toggleHeading(text, start, 2))
                        }
                    >
                        H2
                    </button>
                    <button
                        ...
                        onClick={() =>
                            handleFormat((text, start, end) =>
                                wrapSelection(text, start, end, '**', '**', 'bold')
                            )
                        }
                    >
                        B
                    ...
                    <button
                        ...
                        onClick={() =>
                            handleFormat((text, start, end) =>
                                wrapSelection(text, start, end, '*', '*', 'italic')
                            )
                        }
                    >
                        I
                    ...
                    <button
                        className="markdown-button"
                        onClick={() =>
                            handleFormat((text, start) => insertLinePrefix(text, start, '- '))
                        }
                    >
                        List
                    </button>
                    ...
                    <button
                        ...
                        onClick={() =>
                            handleFormat((text, start, end) =>
                                wrapSelection(text, start, end, '[', '](url)', 'link text')
                            )
                        }
                    >
                        Link
